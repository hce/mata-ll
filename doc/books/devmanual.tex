...
\begin{itemize}[nosep]
  ...
  \item \texttt{LuaTry "name" a} --- Lua \texttt{(val, err)}-convention call,
        result \texttt{IO (Either String a)}
  \item \texttt{LuaCatch "name" a} --- pure call under \texttt{pcall},
        result \texttt{Either String a}
  \item \texttt{LuaIOCatch "name" a} --- IO action under \texttt{pcall},
        result \texttt{IO (Either String a)}
\end{itemize}
