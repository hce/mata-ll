...
\texttt{mll-tests/}  & Test harness (600+ tests) \\
...
cargo test                   # run 600+ tests (needs 32 MB stack)
...
\begin{enumerate}[nosep]
  ...
  \item \textbf{Dead-code elimination} --- drop unused prelude functions and
        specializations (\texttt{dce.rs})
  \item \textbf{Code generation} --- Lua source emission, with integrated
        demand/strictness analysis (\texttt{demand.rs})
\end{enumerate}
...
Tests live in \texttt{mll-tests/tests/cases/} (\textasciitilde190 case files) and
...
\texttt{mllc/src/codegen.rs}      & Lua code generation \\
\bottomrule
\end{tabular}
