...
\texttt{Type} --- Haskell-2010 defaulting.  Class-variable kinds are
inferred from method signatures in \texttt{register\_class} and stored
in \texttt{Checker::class\_kinds} (builtins are seeded in
