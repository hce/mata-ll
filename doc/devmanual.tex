...
Returning \texttt{CompileResult \{ lua\_code, has\_main, exports \}}.
...
\texttt{Maybe} parameters become optional Lua arguments.  The \texttt{export}
keyword wraps return values via \texttt{\_\_mll\_to\_lua} (deep-forces thunks,
converts cons lists to Lua arrays) and incoming callbacks via
\texttt{\_\_mll\_wrap\_callback}.
...
\texttt{Crypto.Ed25519} & \texttt{lib/Crypto/Ed25519.mll} \\
\bottomrule
\end{tabular}
