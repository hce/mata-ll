...
invMixColumn :: Int -> Int -> Int -> Int -> [Int]
...
ctrDecrypt :: [Int] -> [Int] -> [Int] -> [Int]
ctrDecrypt = ctrEncrypt

-- GCM mode
gfShiftRight128 :: [Int] -> [Int]
gfShiftRight128 xs
...
gcmEncrypt :: [Int] -> [Int] -> [Int] -> [Int] -> ([Int], [Int])
...
gcmDecrypt :: [Int] -> [Int] -> [Int] -> [Int] -> ([Int], [Int])
