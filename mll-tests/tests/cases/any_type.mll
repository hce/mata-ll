...
getInteger :: Any -> Int -> Int
getInteger (AnyInt n) _ = n
...
main = do
    ...
    assert (getInteger (AnyInt 99) 0 == 99) "getInteger match"
    ...
    assert (not (isNull (AnyInt 0))) "isNull int false"

    -- List of Any values
    let vals = [AnyString "a", AnyInt 1, AnyNull]
