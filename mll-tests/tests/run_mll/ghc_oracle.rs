...
macro_rules! for_each_ghc_oracle_case {
    ($cb:ident) => {
        ...
        (ghc_oracle_where_polymorphism, "cases", "where_polymorphism.mll"),
        ...
        (ghc_oracle_control_monad_poly, "cases", "control_monad_poly.mll"),
        ...
        (ghc_oracle_dict_mutual_fallback, "cases", "dict_mutual_fallback.mll"),
        ...
        (ghc_oracle_newtype_whnf, "cases", "newtype_whnf.mll"),
        ...
        (ghc_oracle_pattern_guards, "cases", "pattern_guards.mll"),
        ...
        (ghc_oracle_local_signatures, "cases", "local_signatures.mll"),
        ...
        (ghc_oracle_dict_builtin_operators, "cases", "dict_builtin_operators.mll"),
